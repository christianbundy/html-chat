// https://github.com/encharm/Font-Awesome-SVG-PNG/blob/master/white/svg/send.svg
const Send = props => `
<svg width="${props.size}" height="${props.size}" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
  <path
